...
public class MyContentProvider extends ContentProvider {
    ...
    //单项数据
    private static final String STUDENT_TYPE_ITEN = "vnd.android.cursor.item/vnd." + AUTHORIY;
    //数据集合
    ...
    static {
        matcher.addURI(AUTHORIY, TBL_NAME_STUDENT, 1);
